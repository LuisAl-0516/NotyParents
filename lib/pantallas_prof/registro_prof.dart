...
class RegisterProf extends StatefulWidget {
  const RegisterProf({super.key});

  @override
  State<RegisterProf> createState() => _RegisterProfState();
}

class _RegisterProfState extends State<RegisterProf> {
  ...
  Future<void> _register() async {
    ...
    try {
      ...
      // Guardar en Firestore con el campo "aprobado: false"
      await FirebaseFirestore.instance
        ...
        'correo': email,
        'tipo': 'Profesor',
        'aprobado': false, // Inicia como no aprobado
        'createdAt': FieldValue.serverTimestamp(),
      });

      _showDialog('Registro exitoso',
          'Tu cuenta ha sido creada. Espera a que sea aprobada por la administración.');
      Navigator.pushReplacementNamed(context, 'loginprof');
    } on FirebaseAuthException catch (e) {
      _showDialog('Error al registrar', e.message ?? 'Error desconocido');
    } catch (e) {
